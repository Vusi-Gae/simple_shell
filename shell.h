...
/**
 * struct passinfo - contains pseudo-arguements to pass to a func,
 * allowing uniform prototype for func pointer struct
 * @arg: str generated from getline containing arguements
 * @argv:array of stri generated from arg
 * @path: string path for the current command
 * @argc: argument count
 * @line_count: error count
 * @err_num: error code for exit
 * @linecount_flag: if on please count this line of input
 ...
 * @cmd_buf: address of pointer to cmd_buf be on if chaining
 * @cmd_buf_type: CMD_type ||, &&, ;
 * @readfd: the from which to read line input
...
/**
 * struct builtin - contains a builtin str and related func
